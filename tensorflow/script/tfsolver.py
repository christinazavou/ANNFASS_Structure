...
class TFSolver:
    def __init__(self, flags, compute_graph=None, build_solver=build_solver):
        self.flags = flags
        # whether lr is computed from global_steps or from validation loss
        self.val_depended_lr = False if self.flags.lr_type != "plateau" else True
        print(self.val_depended_lr)
